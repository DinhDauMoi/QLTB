            ...
            <div class="col-lg-7">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-4">
                                <div style="display: grid; place-items: center; height: 100%;">
                                    {!! QrCode::encoding('UTF-8')->size(200)->generate($chi_tiet->id . '-' . $chi_tiet->kho->ten_kho . '-' . $chi_tiet->imei) !!}
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="border border-black rounded p-3 text-center mt-3">
                    <div class="d-grid mt-2">
                        <a class="btn btn-sm btn-primary" href="{{ route('generate_pdf',['id'=>$chi_tiet->id]) }}">Tải Mã QR</a>
                    </div>
                    <div class="d-grid mt-2">
